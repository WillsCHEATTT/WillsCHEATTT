...
USER_NAME = os.environ['USER_NAME'] # 'ZackeryRSmith'
...
if __name__ == '__main__':
    ...
    commit_data, commit_time = 0, 0 #perf_counter(commit_counter, 7)
    ...
    # if OWNER_ID == {'id': 'MDQ6VXNlcjcyOTgzMjIx'}: # only calculate for user ZackeryRSmith
